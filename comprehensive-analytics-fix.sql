...
-- This fixes common issues with analytics not showing data

-- ============================================
-- 1. Ensure auth.users table can be accessed
-- ============================================

-- Grant access to auth.users for service role queries
GRANT USAGE ON SCHEMA auth TO postgres, anon, authenticated, service_role;
GRANT SELECT ON auth.users TO postgres, anon, authenticated, service_role;

-- ============================================
-- 2. Fix get_user_metrics function to handle permissions
-- ============================================
...
-- ============================================
-- 3. Ensure all analytics functions are SECURITY DEFINER
-- ============================================

-- This allows them to bypass RLS for analytics purposes
...
SELECT 'Testing get_total_users...' as test;
SELECT get_total_users() as result;

SELECT 'Testing get_user_metrics...' as test;
SELECT * FROM get_user_metrics() LIMIT 3;

SELECT '✅ Analytics functions fixed and tested!' as status;
